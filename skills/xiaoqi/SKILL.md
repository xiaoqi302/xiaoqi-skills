---
name: xiaoqi
description: 小七创作套件的显式路由入口。仅在用户明确调用 $xiaoqi、点名“小七总入口/路由”，或表示不知道该选哪个 xiaoqi skill 时使用；若用户已经明确要研究证据包、公众号文章、新闻快评、技术解释、内容分发、风格审校或某类视觉产物，直接使用对应叶子 skill，不触发本入口。
---
...
| 用户要的产物 | 使用 skill |
|---|---|
| 多来源研究证据包、时间线、主张账本 | `$xiaoqi-research-dossier` |
...
| 将定稿改成不同平台版本 | `$xiaoqi-content-repurpose` |
